    ...
    render (){
        return (    
            <section className="header">
                ...
                :
                    <Link to={"/" + this.props.context + "/"} onMouseEnter={(e)=> this.addBack()} onMouseLeave={(e)=> this.removeBack()} className="arrow"><img src={process.env.PUBLIC_URL + "/images/close.png"} /><h1 className="backtext"><span className="mincho">{this.state.backText_chinese}</span>{this.state.backText_english}</h1></Link>
                }
